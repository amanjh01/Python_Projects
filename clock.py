...
screen.title("Aman's Clock") #title of the GUI
...
def ghadi_bana(ghantaa, minutee, secondd, kalam): #function with 4 parameters
    ...
    kalam.color("Black") #setting the color of the pen to red
    ...
    hands = [("blue", 80, 12), ("red", 150, 60), ("purple", 110, 60)] #the color and the hands set
